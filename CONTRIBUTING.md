...
Thank you for your interest in `cache-http`, an open source project
administered by StrongLoop.

Contributing to `cache-http` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/cache-http)
